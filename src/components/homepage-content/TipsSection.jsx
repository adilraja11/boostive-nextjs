    ...
    <section className='w-full flex flex-col flex-wrap items-center gap-8 px-6 pb-12 md:px-12'>
        ...
        <div className='max-w-6xl md:grid md:grid-cols-2 md:gap-5'>
            <div className='flex justify-center'>
                <Image alt='Ilutrasi Gambar Tips Pertama' src={'/beranda/tips-1.png'} width={300} height={300}></Image>
            </div>
        ...
        <div className='max-w-6xl md:grid md:grid-cols-2 md:gap-5'>
            ...
            <div className='flex justify-center'>
                <Image alt='Ilutrasi Gambar Tips Kedua' src={'/beranda/tips-2.png'} width={300} height={300}></Image>
            </div>
        </div>
        <div className='max-w-6xl md:grid md:grid-cols-2 md:gap-5'>
            <div className='flex justify-center'>
                <Image alt='Ilutrasi Gambar Tips Ketiga' src={'/beranda/tips-3.png'} width={300} height={300}></Image>
            </div>
            <div className='flex flex-col justify-center mt-6'>
        ...
        <div className='max-w-6xl md:grid md:grid-cols-2 md:gap-5'>
            ...
            <div className='flex justify-center'>
                <Image alt='Ilutrasi Gambar Tips Keempat' src={'/beranda/tips-4.png'} width={300} height={300}></Image>
            </div>
        </div>
        <div className='max-w-6xl md:grid md:grid-cols-2 md:gap-5'>
            <div className='flex justify-center'>
                <Image alt='Ilutrasi Gambar Tips Kelima' src={'/beranda/tips-5.png'} width={300} height={300}></Image>
            </div>
            <div className='flex flex-col justify-center mt-6'>
