    ...
    <nav className="navbar bg-white border-solid border-2 border-gray-100">
        <div className="navbar-start">
            <div className="dropdown">
                <label htmlFor="my-drawer" aria-labelledby='menu-button-label' className="drawer-button">
                    <div tabIndex={0} role="button" id='menu-button-label' className="btn btn-ghost btn-circle">
                ...
                <div tabIndex={0} role="button" className="flex items-center gap-2 btn btn-ghost text-base font-normal">
                    <div className="avatar">
                        <div className='w-8 h-8 rounded-full overflow-hidden'>
                            <Image
                                alt={`Gambar Profil dari User ${user.fullName}`}
                                width={75}
                                height={75}
