  ...
  return (
    <div>
        <footer className='footer px-10 py-5 bg-base-200 text-base-content'>
            <div>
                <span className='footer-title text-black'>Features</span>
