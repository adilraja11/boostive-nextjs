      ...
      <div className='hero-content text-left text-primary-content'>
        <div className='grid md:grid-cols-2 gap-12 items-center'>
          <div className='mt-4 lg:mt-0'>
            <h1 className='text-2lg md:text-3lg xl:text-4lg text-red-600 font-medium tracking-tight mb-2'>Tentang Boostive</h1>
          ...
          <Image src={'/hero/hero-tentang-kami.png'} width={300} height={400} className='w-fit mb-4 lg:mb-0 rounded-lg shadow-lg'></Image>
        </div>
      </div>
    </div>
  )
